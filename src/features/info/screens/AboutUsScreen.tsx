      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 100 }} showsVerticalScrollIndicator={false}>
        <SafeAreaView edges={['top']}>
          ...
          <View className="px-6 mt-4 items-end">
            <Text className="font-tajawal-bold text-[14px] text-[#84BD00]">منذ 1953</Text>
          ...
          <View className="px-6 mt-8">
            <View className={`${CARD_BASE_CLASS} bg-[#FAF9F5] p-6 items-center`}>
              ...
              <View className="flex-row gap-3">
                <Pressable className="flex-1 bg-[#84BD00] rounded-[16px] h-12 items-center justify-center">
                  <Text className="font-tajawal-bold text-[15px] text-white">تسوق الان</Text>
                </Pressable>
                <Pressable
                  className="flex-1 bg-[#84BD00] rounded-[16px] h-12 items-center justify-center"
          ...
          <View className="mt-12">
            <View className="items-center mb-6">
              ...
              <View className="w-16 h-1 bg-[#84BD00] mt-2 rounded"></View>
            </View>

            <View className="px-6 mb-4">
              <View className={`${CARD_BASE_CLASS} bg-[#FAF9F5] p-6 items-center pt-8 mt-6`}>
                <View className="absolute -top-6 w-12 h-12 rounded-full bg-[#84BD00] items-center justify-center border-4 border-[#F5F2EC]">
          ...
          <View className="px-6 mt-12 items-center">
            ...
            <Pressable
              className="w-full bg-[#84BD00] rounded-[16px] h-[54px] items-center justify-center mb-6"
